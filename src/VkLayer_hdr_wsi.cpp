...
namespace HdrLayer
{
  ...
  static constexpr std::array s_ExtraHDRSurfaceFormats = {
      ColorDescription{
  ...
  public:
        ...
        VkSurfaceKHR *pSurface)
    {
...

      {
        ...
        wl_display_roundtrip_queue(pCreateInfo->display, queue); // get features/supported_nameds/etc
